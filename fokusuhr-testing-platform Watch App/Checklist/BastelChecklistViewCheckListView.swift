...
struct BastelChecklistItem: Identifiable {
    let id = UUID()
    let title: String
...
enum BastelChecklistState {
    case instructions
    case BastelChecklist
    case completed
}

struct BastelChecklistView: View {
    @State private var allItems: [BastelChecklistItem] = [
        BastelChecklistItem(title: "Eine Schere", imageName: "scissors", color: .red),
        BastelChecklistItem(title: "Ein Lineal", imageName: "ruler", color: .blue),
        BastelChecklistItem(title: "Ein Bleistift", imageName: "pencil", color: .yellow),
        BastelChecklistItem(title: "Ein Leimstift", imageName: "gluestick", color: .purple),
        BastelChecklistItem(title: "Buntes Papier", imageName: "doc.fill", color: .green),
        BastelChecklistItem(title: "Wolle", imageName: "oval.fill", color: .pink),
        BastelChecklistItem(title: "Wackelaugen", imageName: "eye.fill", color: .cyan),
        BastelChecklistItem(title: "Locher", imageName: "circle.grid.cross.fill", color: .orange)
    ]
    
    @State private var remainingItems: [BastelChecklistItem] = []
    @State private var collectedItems: [BastelChecklistItem] = []
    @State private var currentIndex = 0
    @State private var state: BastelChecklistState = .instructions
        ...
        case .instructions:
            InstructionsView {
                withAnimation(.easeInOut) {
                    ...
                    state = .BastelChecklist
                }
            }
        case .BastelChecklist:
            BastelChecklistMainView(
...
struct BastelChecklistMainView: View {
    @Binding var remainingItems: [BastelChecklistItem]
    @Binding var collectedItems: [BastelChecklistItem]
...
struct BastelChecklistCard: View {
    let item: BastelChecklistItem
    let onAdd: () -> Void
    let onSkip: () -> Void
