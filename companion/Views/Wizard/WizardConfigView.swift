...
struct WizardConfigView: View {
    ...
    private var toolTitle: String {
        ...
        case .fidgetToy: return String(localized: "Fidget")
        case .colorBreathing: return String(localized: "Breathing")
        case .fokusMeter: return String(localized: "Meter")
...
struct ColorBreathingConfigSection: View {
    ...
    var body: some View {
        ...
        Section(String(localized: "Feedback")) {
            Toggle(
                String(localized: "Vibration on Transition"), isOn: $config.vibrationOnTransition)
